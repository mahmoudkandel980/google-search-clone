    ...
    return (
        <header className="fixed w-full top-0 bg-white">
            <div className="flex w-full py-6 sm:p-6 items-center">
                ...
                />
                <form className="flex items-center  relative border border-gray-200 rounded-full shadow-lg py-1 px-2 sm:p-6 sm:py-3 ml-2.5 sm:ml-10 mr-2.5 sm:mr-5 flex-grow max-w-3xl">
                    <input
                        type="text"
                    ...
                    />
                    <div className="hidden justify-center sm:flex items-center h-7 w-70 pl-4 sm:border-l-2 border-gray-300">
